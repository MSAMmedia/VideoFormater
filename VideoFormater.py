...
from PyQt6.QtGui import QDragEnterEvent, QDropEvent, QPixmap, QAction, QIcon

from PyQt6.QtCore import QThread, pyqtSignal, QPropertyAnimation, QEasingCurve, QParallelAnimationGroup

# Konstanten definieren (bessere Lesbarkeit und Wartbarkeit)
VERSION_NUMER = "1.0.0"
ICON_PATH = './bundle/VideoFormater.icns'
ICON_PATH_IMAGE = './bundle/VideoFormater_image.png'
APP_NAME = "Video Formater"
...
class VideoConverter(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        about_action.setIcon(QIcon(ICON_PATH))  # Set the icon for the About action
        about_action.triggered.connect(self.show_about_dialog)
        help_menu.addAction(about_action)

        # Help menu
        help_action = QAction("Help", self)
        help_action.setIcon(QIcon(ICON_PATH))  # Set the icon for the Help action
